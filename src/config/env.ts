...
import { DEFAULT_SERVICES_HTML, DEFAULT_UPSTREAM_ERROR_MSG, DEFAULT_DYNAMIC_ROUTES, DEFAULT_IGNORE_URLS_FOR_LOGGING_BY_PREFIX } from './defaultEnv';
...
export const DYNAMIC_ROUTES_INVENTORY_PREFIX = getEnvVar('DYNAMIC_ROUTES_INVENTORY_PREFIX', '/services');